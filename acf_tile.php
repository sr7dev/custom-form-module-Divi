<?php
/*
Plugin Name: [ES Toolbox] MRC CTA
...
if ( ! function_exists( 'acf_initialize_extension' ) ):
/**
 * Creates the extension's main class instance.
 *
 * @since 1.0.0
 */
function acf_initialize_extension() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/AcfTile.php';
...
add_action( 'divi_extensions_init', 'acf_initialize_extension' );
endif;
